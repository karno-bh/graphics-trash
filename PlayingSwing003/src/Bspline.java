...
public class Bspline extends java.applet.Applet implements MouseMotionListener {
	Image buffImage;
	...
	public void drawFun() {
		...
		Color[] iColor = { Color.red, new Color(0f, .7f, 0f), Color.blue, Color.magenta, new Color(0f, .8f, .8f),
