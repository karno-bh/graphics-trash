...
public class FloatCircleExample2 extends JFrame{
...
//	private BufferedImage buffer;
	...
	public FloatCircleExample2(String name) {
		super(name);
...
//		}
	...
	public static void startOnEDT() {
		SwingUtilities.invokeLater(() -> {
			FloatCircleExample2 frame = new FloatCircleExample2("Simple Graphics");
